...
class OerndsSpider(SitemapSpider):
  name = 'oernds_spider'
  sitemap_urls = [
      'https://www.oernds.de/edu-sharing/eduservlet/sitemap?from=0#osds']
  ...
  def parse(self, response):
    ...
    il.add_value('source', 'OERNDS')
    il.add_value('spider', 'oernds_spider')
